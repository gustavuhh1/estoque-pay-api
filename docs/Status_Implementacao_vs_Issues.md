...
- **Pronto, pendente de merge**: #50, #51 e #52 parcial — o PDV fecha venda de ponta a ponta em dinheiro e cartão, com Pix por polling (branch `feature/pagamento-abacatepay-gateway`).
- **Maior lacuna imediata**: da Fase 03 resta a **#53 (cancelamento de venda)** e o que sobrou da **#52** — o webhook em produção, rastreado na **#79** (validar o `?webhookSecret=`, esclarecer qual chave assina o HMAC, idempotência do reenvio e o split de R$ 0,80).
