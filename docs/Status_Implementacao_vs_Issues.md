...
- **Pronto, pendente de merge**: #47/#48/#49 (módulo Estoque: movimentação manual auditada, relatório de auditoria e alertas de estoque mínimo, branch `feature/estoque-auditoria`).
- **Maior lacuna imediata**: com Produtos, Equipe e Categorias resolvidos em `development` e a auditoria de estoque pronta nesta branch, o próximo bloqueio passa a ser a **Fase 03 (PDV, #50–#54)**, que já tem base pronta no schema.
