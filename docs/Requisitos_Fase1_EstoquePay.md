...
* **RF04 - Gestão Completa de Funcionários:** O sistema deve permitir que o Owner ou Gestor gerencie a equipe da loja, incluindo:
  * **Cadastrar:** Adicionar um funcionário via nome, e-mail e cargo (Role).
  * **Listar:** Visualizar todos os funcionários atrelados àquela loja.
  * **Editar:** Alterar o cargo (Role) de um funcionário existente.
  * **Excluir:** Remover o acesso de um funcionário ao estabelecimento.
